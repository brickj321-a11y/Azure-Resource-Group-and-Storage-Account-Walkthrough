...
On the left side of your screen, find the Resource Groups tab. Click it, and then find "create" and click that as well. Give it a name, something simple and easy to remember. Then click "review and create". A pop up window should appear saying "Resource Group Created." (RG Photo 1.png)
